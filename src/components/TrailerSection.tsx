      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 sm:mt-12 sm:gap-8 lg:grid-cols-2">
          {[
            ...
            <article key={trailer.id} className="overflow-hidden rounded-lg border border-border bg-surface-elevated">
        ...
        <p className="mt-6 text-center text-xs text-muted sm:mt-8 sm:text-sm">
